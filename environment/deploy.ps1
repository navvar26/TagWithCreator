$resourceGroupName = "awfunctionsdev1"            # <-- REPLACE the variable values with your own values.
$location = "CentralIndia"                 # <-- Ensure that the location is a valid Azure location
$storageAccountName = "awfunctionsdev"           # <-- Ensure the storage account name is unique
$appServicePlanName = "CentralIndiaplan"   # <--
$appInsightsName = "awfunctionsdev2"              # <--
$functionName = "awfunctionsdev3"                 # <--
